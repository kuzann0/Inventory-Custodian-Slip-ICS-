...
try {
    ...
    $approver_name = isset($data['approver_name']) ? (string)$data['approver_name'] : '';
    $approver_position = isset($data['approver_position']) ? (string)$data['approver_position'] : '';
    $approver_office = isset($data['approver_office']) ? (string)$data['approver_office'] : '';

...
-- Database with Dynamic Data Binding Support
-- Generated: May 14, 2026
-- Migration: Fixed entry_workflow_status table and entries columns
-- ============================================================================
...
--
-- Table structure for table `entries` (UPDATED WITH WORKFLOW COLUMNS)
--
...
CREATE TABLE `entries` (
  ...
  KEY `idx_inspection_status` (`InspectionStatus`),
...
CREATE TABLE `entry_workflow_status` (
  ...
  KEY `idx_created_at` (`created_at`),
  CONSTRAINT `fk_entry_workflow_pr` FOREIGN KEY (`pr_id`) REFERENCES `purchase_requests`(`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_entry_workflow_entries` FOREIGN KEY (`entry_id`) REFERENCES `entries`(`order_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
LOCK TABLES `entry_workflow_status` WRITE;
/*!40000 ALTER TABLE `entry_workflow_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `entry_workflow_status` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-14  0:00:00
-- Database backup with Dynamic Data Binding workflow support
-- All tables have been created with necessary columns and foreign keys
-- The entry_workflow_status table is now available to track workflow steps

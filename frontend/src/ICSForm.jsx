        ...
        <form onSubmit={handleSubmit}>
            ...
            <div style={{ border: '2px solid #ddd', borderRadius: '8px', padding: '20px', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                    <div>
                        <label style={{ display: 'block', marginBottom: '5px', fontWeight: '500', fontSize: '14px' }}>Inventory No.</label>
            ...
            <button type="submit" disabled={isSubmitting} style={{ padding: '12px 30px', backgroundColor: '#051b50', color: '#fff', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '15px' }}>

...
import PurchaseRequestStep2Preview from './components/PurchaseRequestStep2Preview';
...
function NewEntryPR() {
  ...
  const handleCreatePR = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setSubmitMessage(`✓ PR ${finalPrNo} created successfully! Proceeding to preview…`);
        setMessageType('success');
        setTimeout(() => { setSubmitMessage(''); setCurrentStep('preview'); }, 1500);
      } else {
  ...
  // ─── Navigation back ──────────────────────────────────────────────────────
  const goBack = () => {
    const steps = ['create','preview','approval','delivery_note','inspection','form_selection'];
      ...
      <div className="pr-shell">
        <div className="pr-card">
          ...
          <div className="pr-body">
            ...
            {/* STEP 2 – Preview PR (Marina form template with PDF download) */}
            {currentStep === 'preview' && (
            ...
            {/* STEP 4 – Delivery Note (unchanged) */}
            ...
            {/* STEP 6 – Form Selection (unchanged) */}

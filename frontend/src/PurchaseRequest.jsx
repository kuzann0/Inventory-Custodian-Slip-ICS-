...
function NewEntryPR() {
    ...
    const addItemHandler = () => {
        ...
        const newItem = {
            id: Date.now(), // for unique identifier
...
// }
    ...
    const iacGrandTotal = iacAmountRow2;
                        ...
                        <div className={styles.formContainer}>
                            ...
                            {currentStep === 'create' && (
                                <form onSubmit={handleCreatePR}>
                                    ...
                                    <select value={office} onChange={(e) => setOffice(e.target.value)}>
                                        ...
                                        <option value="General Supply Division">S</option>
                                        <option value="Enforcement Service">Enforcement Service (ES)</option>
                                        <option value="Shipyards Regulation Service">Shipyards Regulation Service (SRS)</option>
                                        <option value="Domestic Shipping Service">Domestic Shipping Service (DSS)</option>
                                        <option value="Overseas Shipping Service">Overseas Shipping Service (OSS)</option>
                                    ...
                                    {/* Item Description Field */}
                                            <div>
                                                ...
                                                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                                                      <input 
                                                        ...
                                                        placeholder="Item Description (e.g., Office Chair, Desk Lamp)"
                                            ...
                                            {particularItems.length > 0 && (
                                                <div style={{ marginTop: '15px', marginBottom: '15px', border: '2px solid #161b79', borderRadius: '4px', padding: '12px', backgroundColor: '#f0f8f5' }}>
                                                    <label style={{ fontWeight: 'bold', marginBottom: '10px', display: 'block', color: '#3731df7f', fontSize: '14px' }}>
                                                        ✓ Added Items ({particularItems.length})
                                                    </label>
                                                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
                                                        <thead>
                                                            <tr style={{ borderBottom: '2px solid #2a83d6' }}>
                            ...
                            <div>
                               ...
                               <span>Item No.: <input type="text" placeholder="Item No." value={itemNo} onChange={(e) => setItemNo(e.target.value)} /></span>
                                    ...
                                    <span>Designation: <input type="text" placeholder="Designation" value={designation} onChange={(e) => setDesignation(e.target.value)} /></span>
                                    <div style={{ marginTop: '15px', marginBottom: '15px', border: '2px solid #161b79', borderRadius: '4px', padding: '12px', backgroundColor: '#f0f8f5' }}>
  <span style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
    ...
    <div style={{ display: 'flex', gap: '10px' }}>
      <button
        ...
        style={{
          padding: '6px 16px',
          backgroundColor: certification === 'certified' ? '#161b79' : 'white',
          color: certification === 'certified' ? 'white' : '#161b79',
          border: `1px solid #161b79`,
          borderRadius: '4px',
          cursor: 'pointer',
          transition: 'all 0.2s'
        }}
      ...
      <button
        ...
        style={{
          padding: '6px 16px',
          backgroundColor: certification === 'not-certified' ? '#161b79' : 'white',
          color: certification === 'not-certified' ? 'white' : '#161b79',
          border: `1px solid #161b79`,
          borderRadius: '4px',
          cursor: 'pointer',
          transition: 'all 0.2s'
                                            ...
                                            <div>
                                                ...
                                                <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                                                      <input 
                                                        ...
                                                        value={particular}
                                                        onChange={(e) => setParticular(e.target.value)}
                                                        placeholder="Item particulars (e.g., Office Chair, Desk Lamp)"
                                                        style={{ flex: 1, padding: '8px', border: '1px solid #ddd', borderRadius: '4px', boxSizing: 'border-box' }}
                                                    /> 
                                                    <button 
                                                        type="button"
                            ...
                            <div>
                                            ...
                                            <div>
                                                ...
                                                <input type="number" 
                                                    value={grandTotal || 0}
                                                    disabled
                                                    style={{ width: '100%', padding: '8px', border: '1px solid #ddd', borderRadius: '4px', boxSizing: 'border-box', backgroundColor: '#f4f4f9' }}

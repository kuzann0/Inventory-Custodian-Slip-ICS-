              ...
              <table className={styles.table}>
                <thead>
                  <tr>
                    ...
                    <th onClick={() => handleSort('WorkflowStep')} className={styles.headerCell}>
                      <div className={styles.headerCellContent}><span>Step</span><SortIcon column="WorkflowStep" /></div>
                    </th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    return (
                      <React.Fragment key={entry.order_id}>
                        <tr className={styles.tableRow}>
                          ...
                          <td className={styles.numberCell}>{entry.WorkflowStep || 1}</td>
                        </tr>

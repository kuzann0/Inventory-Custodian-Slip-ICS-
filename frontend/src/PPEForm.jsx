  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1000px' }}>
      <div style={{ marginBottom: '30px' }}>
        ...
        {prNo && (
          <p style={{ marginTop: '10px', fontSize: '14px', color: '#051b50', fontWeight: 'bold' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '20px' }}>
        ...
        <fieldset style={{ border: '1px solid #ddd', padding: '20px', borderRadius: '8px' }}>
          <legend style={{ fontSize: '16px', fontWeight: 'bold', color: '#051b50' }}>1. Property Description</legend>
        ...
        <fieldset style={{ border: '1px solid #ddd', padding: '20px', borderRadius: '8px' }}>
          <legend style={{ fontSize: '16px', fontWeight: 'bold', color: '#051b50' }}>2. Acquisition Details</legend>
        ...
        <fieldset style={{ border: '1px solid #ddd', padding: '20px', borderRadius: '8px' }}>
          <legend style={{ fontSize: '16px', fontWeight: 'bold', color: '#051b50' }}>3. Cost & Quantity</legend>
        ...
        <fieldset style={{ border: '1px solid #ddd', padding: '20px', borderRadius: '8px' }}>
          <legend style={{ fontSize: '16px', fontWeight: 'bold', color: '#051b50' }}>4. Technical Specifications</legend>
        ...
        <fieldset style={{ border: '1px solid #ddd', padding: '20px', borderRadius: '8px' }}>
          <legend style={{ fontSize: '16px', fontWeight: 'bold', color: '#051b50' }}>5. Depreciation & Lifecycle</legend>
        ...
        <fieldset style={{ border: '1px solid #ddd', padding: '20px', borderRadius: '8px' }}>
          <legend style={{ fontSize: '16px', fontWeight: 'bold', color: '#051b50' }}>6. Location & Responsibility</legend>
        ...
        <fieldset style={{ border: '1px solid #ddd', padding: '20px', borderRadius: '8px' }}>
          <legend style={{ fontSize: '16px', fontWeight: 'bold', color: '#051b50' }}>7. Maintenance & Additional Information</legend>
